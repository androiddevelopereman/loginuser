        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ isEditMode ? $t('Edit User') : $t('Add User') }}
                    </h5>
                ...
                <div class="modal-body">
                    <form @submit.prevent="handleSubmit">
                        ...
                        <div :style="{ display: 'flex', justifyContent: 'space-between' }">
                            ...
                            <div class="mb-3">
                                <label for="financial" class="form-label">{{ $t('Financial') }}<span
                                        class="text-danger">*</span></label>
                        ...
                        <div :style="{ display: 'flex', justifyContent: 'space-between' }">
                            ...
                            <div class="mb-3" v-if="!isEditMode">
                                ...
                                <div
                                    :style="{ position: 'relative', width: '100%', height: '5px', backgroundColor: 'gray', marginTop: '5px' }">
                                    <div
                                        :style="{ position: 'absolute', height: '5px', width: passwordStrengthWidth, backgroundColor: passwordStrengthColor, borderRadius: '3px' }">
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Confirm Password -->
                            <div class="mb-3" v-if="!isEditMode">
                                <label for="confirmPassword" class="form-label">{{ $t('Confirm Password') }}<span
                                        class="text-danger">*</span></label>
                        ...
                        <div :style="{ display: 'flex', justifyContent: 'space-between' }">
                            <div class="mb-3 w-50">
                                <label for="userType" class="form-label">{{ $t('User Type') }}<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary"
                                :data-bs-dismiss="isPasswordMatched ? null : 'modal'" id="saveButton">{{ isEditMode ?
                                    $t('Update') : $t('Save') }}</button>
                        </div>
                    </form>
                </div>
            </div>
...
const passwordStrength = computed(() => {
    ...
    if (password.value.match(/^(?=.[a-z])(?=.[A-Z])(?=.*[0-9]).{6,}$/)) return "strong";
    return "medium";
});
